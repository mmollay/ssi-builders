...
**IMPORTANT:** Always check `/Users/martinmollay/Development/ssi-builders/SSI-BUILDER-TODO.md` for:
- 🐛 Open Bugs (Priority: High)
- 🚀 Feature Requests
- 📝 Enhancements
- Version Planning

This file is the central hub for all SSI-Builder issues across all projects.
